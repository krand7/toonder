class CharactersController < ApplicationController
  ...
  def create
    @character = Character.where(user_id: current_user.id).new(character_params)
  ...
  def destroy
    @character.destroy
    respond_to do |format|
      format.html { redirect_to characters_path, notice: 'Character was successfully destroyed.' }
